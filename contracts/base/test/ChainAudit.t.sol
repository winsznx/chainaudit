...
import "../src/ChainAudit.sol";

contract UchainauditTest is Test {
    Uchainaudit public registry;
    ...
    function testCannotRegisterDuplicateName() public {
        ...
        vm.prank(user2);
        vm.expectRevert(Uchainaudit.NameAlreadyRegistered.selector);
        registry.registerName("alice");
    }
    ...
    function testCannotTransferUnownedName() public {
        ...
        vm.prank(user2);
        vm.expectRevert(Uchainaudit.NotNameOwner.selector);
        registry.transferName("alice", user2);
    }
    ...
    function testInvalidNameLength() public {
        vm.prank(user1);
        vm.expectRevert(Uchainaudit.InvalidName.selector);
